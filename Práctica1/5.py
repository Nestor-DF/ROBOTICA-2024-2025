...
T1_2p = matriz_T(d[2], th[2], a[2], al[2])
T2p_2 = matriz_T(d[3], th[3], a[3], al[3])
T2_3 = matriz_T(d[4], th[4], a[4], al[4])
T3_41 = matriz_T(d[5], th[5], a[5], al[5])
T3_42 = matriz_T(d[6], th[6], a[6], al[6])
T3_EF = matriz_T(d[7], th[7], a[7], al[7])

T0_1 = np.dot(T0_1p, T1p_1)
T0_2p = np.dot(T0_1, T1_2p)
T0_2 = np.dot(T0_2p, T2p_2)
T0_3 = np.dot(T0_2, T2_3)
T0_41 = np.dot(T0_3, T3_41)
T0_42 = np.dot(T0_3, T3_42)
T0_EF = np.dot(T0_3, T3_EF)


# Transformación de cada articulación
o11p0 = np.dot(T0_1p, o00).tolist()
o110 = np.dot(T0_1, o00).tolist()
o22p0 = np.dot(T0_2p, o00).tolist()
o220 = np.dot(T0_2, o00).tolist()
o330 = np.dot(T0_3, o00).tolist()
o4410 = np.dot(T0_41, o00).tolist()
o4420 = np.dot(T0_42, o00).tolist()
oEF0 = np.dot(T0_EF, o00).tolist()


# Mostrar resultado de la cinemática directa
muestra_origenes([o00, o11p0, o110, o22p0, o220, o330, [[o4410], [o4420]]], oEF0)
muestra_robot([o00, o11p0, o110, o22p0, o220, o330, [[o4410], [o4420]]], oEF0)
input()
